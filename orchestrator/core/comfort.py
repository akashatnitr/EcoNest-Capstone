"""Storage primitives for explainable comfort-preference learning."""
...
async def ensure_comfort_observations_schema(session: AsyncSession) -> None:
    """Create the comfort observation table for fresh and existing installs."""
    await session.execute(text(COMFORT_OBSERVATIONS_SCHEMA))
